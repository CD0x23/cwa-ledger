...
static const bagl_element_t const bagl_ui_approval_blue[] = {
    ...
    {
        {BAGL_BUTTON | BAGL_FLAG_TOUCHABLE, 0x00, 30, 400, 120, 40, 0, 6,
         BAGL_FILL, 0x9F3A38, 0xF9F9F9, BAGL_FONT_OPEN_SANS_LIGHT_14px |
    ...
    {
        {BAGL_BUTTON | BAGL_FLAG_TOUCHABLE, 0x00, 180, 400, 120, 40, 0, 6,
         BAGL_FILL, 0x00AD68, 0xF9F9F9, BAGL_FONT_OPEN_SANS_LIGHT_14px |
         BAGL_FONT_ALIGNMENT_CENTER | BAGL_FONT_ALIGNMENT_MIDDLE, 0},
        "Onayla",
        0,
        0x1AC782,
    ...
    {
       {BAGL_LABELINE , 0x00, 10, 225, 200, 30, 0, 0, BAGL_FILL, 0x000000,
       COLOR_BG_1, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX|BAGL_FONT_ALIGNMENT_LEFT, 0 },
       "  Tarih",
       0,
       0,
    ...
    {
       {BAGL_LABELINE , 0x00, 10, 275, 200, 30, 0, 0, BAGL_FILL, 0x000000,
       COLOR_BG_1, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX|BAGL_FONT_ALIGNMENT_LEFT, 0 },
       "  Miktar:",
       0,
       0,
